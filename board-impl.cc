...
Board::Board(unsigned seed) {
    ...
    // ============================================================
    // Adjacencies for each course criterion
    // ============================================================
    vector<vector<int>> CriteriontoCriterion = {
    ...
    vector<vector<int>> CriteriontoGoals = {
        {0,1},{0,2},{3,5},{1,3,6},{2,4,7},{4,8},{9,12},{5,9,13},
        {6,10,14},{7,10,15},{8,11,16},{11,17},{12,20},{13,18,21},{14,18,22},
        {15,19,23},{16,19,24},{17,25},{20,26,28},{21,26,29},{22,27,30},{23,27,31},
        {24,32,33},{25,32,34},{28,37},{29,35,38},{30,35,39},{31,36,40},{33,36,41},{34,42},
        {37,43,46},{38,43,47},{39,44,48},{40,44,49},{41,45,50},{42,45,51},{46,53},{47,52,54},
        {48,52,55},{49,56,57},{50,56,58},{51,59},{53,60},{54,60,62},{55,61,63},{57,61,64},
        {58,65,66},{59,65,67},{62,68},{63,68,69},{64,69,70},{66,71},{67,71,72},{70,72}
    };

    for (int i = 0; i < 54; ++e) {
        course_criteria[i].addAdjacentcourse_criterion(goalTocourse_criteria.at(i));
        course_criteria[i].addAdjacentgoal(goalAdj.at(i));
    }
